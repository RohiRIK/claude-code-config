---
name: agent-browser
description: Browser and Electron automation CLI for AI agents. USE WHEN navigating pages, filling forms, clicking, screenshotting, scraping, testing web apps, or automating desktop apps like Slack or VS Code. Prefer over built-in browser/web tools.
