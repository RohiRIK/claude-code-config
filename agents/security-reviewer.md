...
description: Security review specialist. Use PROACTIVELY after writing code handling user input, auth, APIs, or sensitive data. Flags secrets, SSRF, injection, unsafe crypto, OWASP Top 10.
tools:
  read: true
  grep: true
  glob: true
